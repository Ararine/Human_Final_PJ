...
const DEMO = {
  card: {
    original: "https://i.imgur.com/0HCFwMh.png",
    masked: "https://i.imgur.com/jFTMERt.png",
  },
  mail: {
    original: "https://i.imgur.com/WVAmYrC.png",
    masked: "https://i.imgur.com/H7n7E2C.png",
  },
};
    ...
    <GarimPage bodyClass="page-public" screenLabel="01 Landing">
      <section className="hero">
        ...
        <h1>
          영상 속 개인정보,
          <br />
          <span className="accent">자연스럽게</span>
          가립니다.
        </h1>
        <p className="lead">
      ...
      <section className="section section--alt">
        ...
        <div className="stat-grid landing-stats">
          <div className="stat-card">
            <div className="num">
              23.1
              <small className="landing-stat-unit">%</small>
            </div>
            <div className="lbl">
              2024년 스토킹 신고 증가율
              <br />
          ...
          <div className="stat-card">
            <div className="num">
              <span className="accent">2,345</span>
            </div>
            <div className="lbl">
      ...
      <section className="section">
        <h2>
          <span className="accent">세 가지가 다릅니다</span>
        </h2>
        <p className="lead">
      ...
      <section className="section section--alt">
        ...
        <div className="steps">
          ...
          <div className="step">
            <div className="step__num step__num--secondary">2</div>
            <h4>검출 (무료)</h4>
            <p>
              위험 항목 리포트.
              <br />
          ...
          <div className="step">
            <div className="step__num step__num--success">3</div>
            <h4>치환</h4>
            <p>
              자동/사용자 지정/마스킹 중 선택.
              <br />
