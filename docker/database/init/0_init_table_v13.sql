...
COMMENT ON COLUMN plans.price_amount IS '월 결제 가격 - 월 결제 또는 월 기준 과금 계산에 사용하는 금액 값';
COMMENT ON COLUMN plans.yearly_price_amount IS '연 결제 전용 가격 - 값이 없으면 price_amount * 10 계산값을 사용';
...
COMMENT ON COLUMN plans.credits IS '월 제공 크레딧 - 월 결제 요금제 구매 시 부여되는 사용 가능 크레딧 수';
COMMENT ON COLUMN plans.yearly_credits IS '연 제공 크레딧 - 값이 없으면 credits * 12 계산값을 사용';
...
COMMENT ON COLUMN notification_events.read_at IS '읽음 일시 - 사용자가 알림을 읽은 시각';
...
ALTER TABLE analysis_jobs
    DROP CONSTRAINT IF EXISTS ck_analysis_jobs_job_type_v4;
...
INSERT INTO plans (
    ...
    watermark_required, price_amount, yearly_price_amount, sort_order, status,
    file_size_limit, max_jobs, auto_delete_original_hours,
    metadata_retention_days, credits, yearly_credits
)
VALUES
 ('free', 'Free', 'Basic', 'mui-chip--primary', '개인 진단과 가벼운 체험을 위한 무료 플랜.', 5, 0, true, 0, NULL, 10, 'active', 50, 3, 12, 90, 10, NULL),
    ('pro', 'Pro', 'Most Popular', 'mui-chip--soft-warning', '정기적으로 영상을 다루는 크리에이터를 위한 플랜.', 50, 7, false, 9900, NULL, 20, 'active', 500, 10, 12, 90, 60, NULL),
    ('studio', 'Studio', 'Team', 'mui-chip--secondary', '팀 단위 작업과 대량 분석을 위한 최상위 플랜.', null, 14, false, 19800, NULL, 30, 'active', 2048, 30, 12, 90, 150, NULL)
...
INSERT INTO plans (
    ...
    price_amount, yearly_price_amount, sort_order, status, file_size_limit, max_jobs,
    auto_delete_original_hours, metadata_retention_days, credits, yearly_credits
)
VALUES
    ('enterprise', 'Enterprise', '엔터프라이즈', 'mui-chip--success', '대규모 팀과 비즈니스를 위한 고급 기능 플랜입니다.', NULL, 90, false, 49000, NULL, 40, 'inactive', 10240, 100, 24, 365, 2000, NULL),
    ('starter_light', 'Starter Light', '테스트', 'mui-chip--soft-info', '가벼운 테스트와 데모 환경 검증을 위한 비노출 플랜입니다.', 10, 3, true, 900, NULL, 50, 'inactive', 100, 3, 12, 90, 10, NULL),
    ('starter_plus', 'Starter Plus', '테스트', 'mui-chip--soft-info', '소규모 개인 테스트를 위한 예비 플랜입니다.', 20, 5, true, 1900, NULL, 60, 'inactive', 200, 5, 12, 90, 20, NULL),
    ('creator_basic', 'Creator Basic', '크리에이터', 'mui-chip--soft-primary', '개인 크리에이터의 정기 영상 분석을 위한 예비 플랜입니다.', 30, 7, false, 3900, NULL, 70, 'inactive', 300, 5, 12, 90, 35, NULL),
    ('creator_plus', 'Creator Plus', '크리에이터', 'mui-chip--soft-primary', '영상 업로드가 잦은 크리에이터를 위한 예비 플랜입니다.', 60, 10, false, 5900, NULL, 80, 'inactive', 700, 8, 12, 120, 80, NULL),
    ('creator_pro', 'Creator Pro', '크리에이터', 'mui-chip--soft-primary', '고빈도 영상 분석 사용자를 위한 예비 플랜입니다.', 100, 14, false, 8900, NULL, 90, 'inactive', 1024, 10, 12, 120, 120, NULL),
    ('team_basic', 'Team Basic', '팀', 'mui-chip--secondary', '소규모 팀 단위 협업을 위한 예비 플랜입니다.', 150, 14, false, 12900, NULL, 100, 'inactive', 1536, 15, 12, 180, 180, NULL),
    ('team_plus', 'Team Plus', '팀', 'mui-chip--secondary', '팀 단위 대량 분석을 위한 예비 플랜입니다.', 250, 21, false, 16900, NULL, 110, 'inactive', 2048, 20, 12, 180, 300, NULL),
    ('team_pro', 'Team Pro', '팀', 'mui-chip--secondary', '전문 팀의 반복 분석 작업을 위한 예비 플랜입니다.', 400, 30, false, 24900, NULL, 120, 'inactive', 3072, 30, 24, 180, 500, NULL),
    ('studio_plus', 'Studio Plus', '스튜디오', 'mui-chip--secondary', '스튜디오급 대용량 파일 처리를 위한 예비 플랜입니다.', NULL, 45, false, 29900, NULL, 130, 'inactive', 4096, 40, 24, 270, 800, NULL),
    ('studio_max', 'Studio Max', '스튜디오', 'mui-chip--secondary', '고용량 영상과 다중 작업 처리를 위한 예비 플랜입니다.', NULL, 60, false, 39900, NULL, 140, 'inactive', 6144, 60, 24, 270, 1200, NULL),
    ('business_light', 'Business Light', '비즈니스', 'mui-chip--success', '소규모 비즈니스 운영 검증을 위한 예비 플랜입니다.', 500, 45, false, 45900, NULL, 150, 'inactive', 5120, 50, 24, 365, 1500, NULL),
    ('business_plus', 'Business Plus', '비즈니스', 'mui-chip--success', '비즈니스 팀의 안정적인 분석 운영을 위한 예비 플랜입니다.', 800, 60, false, 59000, NULL, 160, 'inactive', 8192, 80, 24, 365, 2500, NULL),
    ('business_max', 'Business Max', '비즈니스', 'mui-chip--success', '고객사 단위 확장 운영을 위한 예비 플랜입니다.', NULL, 90, false, 79000, NULL, 170, 'inactive', 10240, 120, 24, 365, 4000, NULL),
    ('edu_basic', 'Education Basic', '교육', 'mui-chip--soft-warning', '교육기관 테스트를 위한 예비 플랜입니다.', 80, 14, false, 4900, NULL, 180, 'inactive', 512, 10, 12, 180, 100, NULL),
    ('edu_plus', 'Education Plus', '교육', 'mui-chip--soft-warning', '교육기관 수업 및 실습용 예비 플랜입니다.', 200, 30, false, 9900, NULL, 190, 'inactive', 1024, 20, 12, 180, 250, NULL),
    ('admin_test', 'Admin Test', '관리자', 'mui-chip--default', '관리자 정책 검증을 위한 내부 테스트 플랜입니다.', 999, 7, false, 100, NULL, 200, 'inactive', 128, 3, 1, 30, 999, NULL)
ON CONFLICT (plan_code) DO UPDATE
SET
    plan_name = EXCLUDED.plan_name,
    badge_label = EXCLUDED.badge_label,
...
COMMENT ON COLUMN subscriptions.billing_period_days IS '구독 결제 주기 일수 - 월 결제 30일, 연 결제 365일';
